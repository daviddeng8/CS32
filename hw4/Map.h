...
// Exchange the contents of this map with the other one.
    ...
    Map(const Map<KeyType, ValueType>& other) :m_size(other.m_size) {
...
template<typename KeyType, typename ValueType> bool combine(const Map<KeyType, ValueType>& m1, const Map<KeyType, ValueType>& m2, Map<KeyType, ValueType>& result) {
...
template<typename KeyType, typename ValueType> void reassign(const Map<KeyType, ValueType>& m, Map<KeyType, ValueType>& result) {
